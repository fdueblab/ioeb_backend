...
MOCK_SERVICE_APIS = [
    ...
    },
    {
        ...
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"生成分析报告\",\"content\":\"请基于以下数据生成一份详细的分析报告：销售额120万，增长率15%，客户满意度92%\"}]",
        "response": "{\"steps\":[{\"step\":\"连接样例报告生成MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到样例报告生成MCP服务器\"},{\"step\":\"解析数据输入\",\"status\":\"completed\",\"message\":\"正在解析用户提供的数据和报告要求\"},{\"step\":\"执行课题五算法\",\"status\":\"completed\",\"message\":\"正在运行课题五算法进行数据分析和报告结构化\"},{\"step\":\"生成报告内容\",\"status\":\"completed\",\"message\":\"正在生成报告的各个章节和内容\"},{\"step\":\"格式化输出\",\"status\":\"completed\",\"message\":\"正在对报告进行格式化和质量检查\"}],\"final_result\":{\"response\":\"报告生成完成。基于提供的数据，生成了包含执行摘要、数据分析、趋势预测和建议措施四个部分的详细分析报告。销售额120万元表现良好，15%的增长率符合预期，92%的客户满意度显示服务质量优秀。建议继续保持现有策略并加强客户关系维护。\"}}"
    },
    {
        ...
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"风险识别分析\",\"content\":\"请对以下客户进行风险识别：客户年龄35岁，月收入8000元，负债率60%，信用记录良好\"}]",
        "response": "{\"steps\":[{\"step\":\"连接课题一风险识别模型推理MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到课题一风险识别模型推理MCP服务器\"},{\"step\":\"数据预处理\",\"status\":\"completed\",\"message\":\"正在对客户数据进行标准化和特征提取\"},{\"step\":\"模型推理执行\",\"status\":\"completed\",\"message\":\"正在运行课题一风险识别算法进行推理分析\"},{\"step\":\"风险评估计算\",\"status\":\"completed\",\"message\":\"正在计算各维度风险指标和综合评分\"},{\"step\":\"结果输出\",\"status\":\"completed\",\"message\":\"正在生成风险识别结果和建议\"}],\"final_result\":{\"response\":\"风险识别分析完成。该客户综合风险评级为中等风险。年龄和收入水平适中，但负债率60%偏高，存在一定还款压力。信用记录良好是积极因素。建议采取适度风控措施，可考虑提供有限额度的金融服务，并加强后续监控。\"}}"
    },
    {
        ...
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"金融风险报告生成\",\"content\":\"请生成本季度的金融风险报告，包含信用风险、市场风险和操作风险三个维度的分析\"}]",
        "response": "{\"steps\":[{\"step\":\"连接课题三金融风险报告生成MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到课题三金融风险报告生成MCP服务器\"},{\"step\":\"数据收集整理\",\"status\":\"completed\",\"message\":\"正在收集本季度各类风险数据和指标\"},{\"step\":\"课题三算法分析\",\"status\":\"completed\",\"message\":\"正在运行课题三算法进行多维度风险分析\"},{\"step\":\"风险报告编制\",\"status\":\"completed\",\"message\":\"正在编制信用风险、市场风险和操作风险分析报告\"},{\"step\":\"报告审核输出\",\"status\":\"completed\",\"message\":\"正在进行报告质量审核和最终输出\"}],\"final_result\":{\"response\":\"本季度金融风险报告生成完成。信用风险方面，不良贷款率控制在2.1%，处于合理区间。市场风险方面，VaR值为150万元，风险敞口可控。操作风险方面，发生3起轻微操作失误，已完成整改。总体而言，本季度风险状况稳定，建议继续加强风险监控和预警机制建设。\"}}"
    },
    {
        ...
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"模型安全性指纹检测\",\"content\":\"请对目标机器学习模型进行安全性指纹检测，评估其抗攻击能力和安全风险等级\"}]",
        "response": "{\"steps\":[{\"step\":\"连接课题四模型评测-安全性指纹MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到课题四模型评测-安全性指纹MCP服务器\"},{\"step\":\"模型结构分析\",\"status\":\"completed\",\"message\":\"正在分析目标模型的架构和参数特征\"},{\"step\":\"安全性指纹提取\",\"status\":\"completed\",\"message\":\"正在运行课题四算法提取模型安全性指纹\"},{\"step\":\"攻击模拟测试\",\"status\":\"completed\",\"message\":\"正在进行多种攻击场景的模拟测试\"},{\"step\":\"安全评估报告\",\"status\":\"completed\",\"message\":\"正在生成安全性评估结果和防护建议\"}],\"final_result\":{\"response\":\"模型安全性指纹检测完成。检测到模型存在中等程度的对抗攻击漏洞，在梯度攻击下准确率下降约12%。模型指纹特征显示其对数据投毒攻击具有一定抗性。安全风险等级评定为B级。建议实施对抗训练强化和输入数据验证机制来提升安全性。\"}}"
    },
    {
