API_IDS = {
    ...
    "情感分析MCP Server": "94395fbc-7349-4a06-80db-04c417f4bd04",
    ...
    "交易风险预测算法下载": "ga001api-3c4d-5e6f-7890-123456789001",
    "航线智能规划算法下载": "ga002api-3c4d-5e6f-7890-123456789002",
    "病虫害识别算法下载": "ga003api-3c4d-5e6f-7890-123456789003",
    "人体异常行为分类算法下载": "ga004api-3c4d-5e6f-7890-123456789004",
}
...
MOCK_SERVICES = [
    ...
    },
    {
        ...
        "technology": "1",
        "network": "ioeb_app-network",
        "port": "8771/tcp → 0.0.0.0:8771 :::8771",
        "volume": "/home/ubuntu/ioeb/api/Project_1/mcp -> /app/mcp",
        "status": "released",
        "number": 89,
        "deleted": 0,
        "create_time": 1744635999632,
    ...
    },
    {
        ...
        "technology": "3",
        "network": "ioeb_app-network",
        "port": "8772/tcp → 0.0.0.0:8772 :::8772",
        "volume": "/home/ubuntu/ioeb/api/report-generation/mcp -> /app/mcp",
        "status": "pre_release_unrated",
        "number": 45,
        "deleted": 0,
        "create_time": 1744635999632,
    ...
    },
    {
        ...
        "technology": "4",
        "network": "ioeb_app-network",
        "port": "8773/tcp → 0.0.0.0:8773 :::8773",
        "volume": "/home/ubuntu/ioeb/api/Project-3/mcp -> /app/mcp",
        "status": "released",
        "number": 26,
        "deleted": 0,
        "create_time": 1744635999632,
    ...
    },
    {
        ...
        "technology": "4",
        "network": "ioeb_app-network",
        "port": "8774/tcp → 0.0.0.0:8774 :::8774",
        "volume": "/home/ubuntu/ioeb/api/Project-4/mcp -> /app/mcp",
        "status": "released",
        "number": 134,
        "deleted": 0,
        "create_time": 1744635999632,
    ...
    {
        "id": "ad43a293-fb67-4efb-b65b-ec22d9cca5bg",
        "name": "AML风险检测MCP服务",
        "attribute": "custom",
        "type": "atomic_mcp",
        "domain": "aml",
        ...
        "technology": "0",
        "network": "bridge",
        "port": "26020/tcp → 0.0.0.0:26020 :::26020",
        "volume": "",
        "status": "pre_release_unrated",
        "number": 7,
        "deleted": 0,
    ...
    {
        "id": "ad43a293-fb67-4efb-b65b-ec22d9cca5af",
        "name": "家庭机器人3D语义分割MCP服务",
        "attribute": "open_source",
        "type": "atomic_mcp",
        "domain": "homeAI",
        "industry": "0",
        ...
        "technology": "2",
        "network": "bridge",
        "port": "26025/tcp → 0.0.0.0:26025 :::26025",
        "volume": "",
        "status": "released",
        "number": 7,
        "deleted": 0,
    ...
    {
        "id": "3d93a110-4618-4b12-83fd-4b5a6f89a106",
        "name": "无人机虚拟仿真MCP服务",
        "attribute": "open_source",
        "type": "atomic_mcp",
        "domain": "aircraft",
        ...
        "technology": "1",
        "network": "ioeb_app-network",
        "port": "8775/tcp → 0.0.0.0:8775 :::8775",
        "volume": "/home/ubuntu/ioeb/api/aircraft-simulation/mcp -> /app/mcp",
        "status": "pre_release_unrated",
        "number": 156,
        "deleted": 0,
        "create_time": 1744635999635,
    ...
    {
        "id": "78064ca6-3a5d-49cd-8a27-c6a7b52fc20f",
        "name": "无人机低空测绘MCP服务",
        "attribute": "open_source",
        "type": "atomic_mcp",
        "domain": "aircraft",
        ...
        "technology": "2",
        "network": "ioeb_app-network",
        "port": "8776/tcp → 0.0.0.0:8776 :::8776",
        "volume": "/home/ubuntu/ioeb/api/aircraft-mapping/mcp -> /app/mcp",
        "status": "pre_release_unrated",
        "number": 98,
        "deleted": 0,
        "create_time": 1744635999635,
    ...
    },
    {
        ...
        "technology": "2",
        "network": "ioeb_app-network",
        "port": "8795/tcp → 0.0.0.0:8795 :::8795",
        "volume": "/home/ubuntu/ioeb/api/aircraft-detection/mcp -> /app/mcp",
        "status": "pre_release_unrated",
        "number": 142,
        "deleted": 0,
        "create_time": 1744635999635,
    ...
    },
    {
        ...
        "technology": "3",
        "network": "ioeb_app-network",
        "port": "8796/tcp → 0.0.0.0:8796 :::8796",
        "volume": "/home/ubuntu/ioeb/api/aircraft-control/mcp -> /app/mcp",
        "status": "pre_release_unrated",
        "number": 73,
        "deleted": 0,
        "create_time": 1744635999635,
    ...
    {
        "id": "abcc5100-a017-49d9-a784-c7fe210d234d",
        "name": "无人机视频分析MCP服务",
        "attribute": "paid",
        "type": "atomic_mcp",
        "domain": "aircraft",
        ...
        "technology": "4",
        "network": "ioeb_app-network",
        "port": "8797/tcp → 0.0.0.0:8797 :::8797",
        "volume": "/home/ubuntu/ioeb/api/aircraft-video/mcp -> /app/mcp",
        "status": "pre_release_unrated",
        "number": 127,
        "deleted": 0,
        "create_time": 1744635999635,
    ...
    {
        "id": "1e5dc8b7-34a7-4b2d-9fd8-c2a8d5e0b3f4",
        "name": "金融欺诈检测推理元应用",
        "attribute": "custom",
        "type": "meta",
        "domain": "aml",
        ...
        "technology": "2",
        "network": "bridge",
        "port": "0.0.0.0:8300/TCP → 0.0.0.0:83000",
        "volume": "/var/opt/gitlab/mnt/user  →  /appdata/aml/fraud-detection",
        "status": "pre_release_unrated",
        "number": 678,
        "deleted": 0,
        "create_time": 1744635999660,
        "creator_id": "",
    },
    {
        "id": "8f3dc9c8-45b8-4c3e-8fe9-d3b9e6f1c4g5",
        "name": "智能飞行控制元应用",
        "attribute": "open_source",
        "type": "meta",
        "domain": "aircraft",
        ...
        "technology": "2",
        "network": "bridge",
        "port": "0.0.0.0:8400/TCP → 0.0.0.0:84000",
        "volume": "/var/opt/gitlab/mnt/user  →  /appdata/aircraft/flight-control",
        "status": "released",
        "number": 543,
        "deleted": 0,
        "create_time": 1744635999661,
        "creator_id": "",
    },
    {
        "id": "healthbb-fb30-492d-93cf-b608e06b4d7a",
        "name": "情感分析微服务",
        "attribute": "open_source",
        "type": "atomic",
        "domain": "homeAI",
        ...
        "technology": "1",
        "network": "ioeb_app-network",
        "port": "0.0.0.0:8000/tcp → 0.0.0.0:27001",
        "volume": "",
        "status": "pre_release_unrated",
        "number": 1,
        "deleted": 0,
        "create_time": 1758099300000,
        "creator_id": "",
    },
    {
        "id": "healthbb-fb30-492d-93cf-b608e06b4d7z",
        "name": "情感分析MCP服务",
        "attribute": "open_source",
        "type": "atomic_mcp",
        "domain": "homeAI",
    ...
    {
        "id": "ga001a2b-3c4d-5e6f-7890-123456789001",
        "name": "跨境支付交易风险预测算法",
        "attribute": "custom",
    ...
    {
        "id": "ga002a2b-3c4d-5e6f-7890-123456789002",
        "name": "无人机航线智能规划算法",
        "attribute": "custom",
        "type": "generated_algorithm",
        "domain": "aircraft",
    ...
    {
        "id": "ga003a2b-3c4d-5e6f-7890-123456789003",
        "name": "农作物病虫害识别算法",
        "attribute": "custom",
        "type": "generated_algorithm",
        "domain": "agriculture",
    ...
    {
        "id": "ga004a2b-3c4d-5e6f-7890-123456789004",
        "name": "基于姿态估计的人体异常行为分类算法",
        "attribute": "custom",
        "type": "generated_algorithm",
        "domain": "health",
        "industry": "0",
...
MOCK_SERVICE_SOURCES = [
    ...
    {
        "id": "14096ab0-7e2b-42aa-87ad-fa03ff97b88d",
        "service_id": "8f3dc9c8-45b8-4c3e-8fe9-d3b9e6f1c4g5",
        "popover_title": "可信云技术服务溯源",
        "company_name": "复旦大学课题组",
        "company_address": "上海市杨浦区邯郸路220号",
        "company_contact": "021-65642222",
        "company_introduce": "无人飞机AI应用课题",
        "ms_introduce": "无人智能飞机",
        "company_score": 5,
        "ms_score": 5,
    },
    {
        "id": "14096ab0-7e2b-42aa-87ad-fa03ff97b88e",
        "service_id": "healthbb-fb30-492d-93cf-b608e06b4d7z",
        "popover_title": "可信云技术服务溯源",
        "company_name": "复旦大学课题组",
        "company_address": "上海市杨浦区邯郸路220号",
        "company_contact": "021-65642222",
    ...
    {
        "id": "14096ab0-7e2b-42aa-87ad-fa03ff97b88f",
        "service_id": "1e5dc8b7-34a7-4b2d-9fd8-c2a8d5e0b3f4",
        "popover_title": "可信云技术服务溯源",
        "company_name": "复旦大学课题组",
        "company_address": "上海市杨浦区邯郸路220号",
        "company_contact": "021-65642222",
        "company_introduce": "反洗钱AI应用课题",
        "ms_introduce": "支付检测",
        "company_score": 5,
        "ms_score": 5,
    },
    {
        "id": "ga001src-3c4d-5e6f-7890-123456789001",
        "service_id": "ga001a2b-3c4d-5e6f-7890-123456789001",
        "popover_title": "想定式算法生成溯源",
        "company_name": "平台智能体自动生成",
        "company_address": "上海市杨浦区邯郸路220号",
        "company_contact": "021-65642222",
        "company_introduce": "基于想定式开发模块，由AI智能体自动生成的交易风险预测算法",
        "ms_introduce": "利用机器学习模型对跨境支付交易进行实时风险评分与预测",
        "company_score": 5,
        "ms_score": 4,
    },
    {
        "id": "ga002src-3c4d-5e6f-7890-123456789002",
        "service_id": "ga002a2b-3c4d-5e6f-7890-123456789002",
        "popover_title": "想定式算法生成溯源",
        "company_name": "平台智能体自动生成",
        "company_address": "上海市杨浦区邯郸路220号",
        "company_contact": "021-65642222",
        "company_introduce": "基于想定式开发模块，由AI智能体自动生成的无人机航线规划算法",
        "ms_introduce": "结合地形与气象数据，为无人机低空物流配送提供最优航线规划",
        "company_score": 5,
        "ms_score": 4,
    },
    {
        "id": "ga003src-3c4d-5e6f-7890-123456789003",
        "service_id": "ga003a2b-3c4d-5e6f-7890-123456789003",
        "popover_title": "想定式算法生成溯源",
        "company_name": "平台智能体自动生成",
        "company_address": "上海市杨浦区邯郸路220号",
        "company_contact": "021-65642222",
        "company_introduce": "基于想定式开发模块，由AI智能体自动生成的农作物病虫害识别算法",
        "ms_introduce": "基于计算机视觉技术，对农作物叶片图像进行病虫害类型识别与分级",
        "company_score": 5,
        "ms_score": 4,
    },
    {
        "id": "ga004src-3c4d-5e6f-7890-123456789004",
        "service_id": "ga004a2b-3c4d-5e6f-7890-123456789004",
        "popover_title": "想定式算法生成溯源",
        "company_name": "平台智能体自动生成",
        "company_address": "上海市杨浦区邯郸路220号",
        "company_contact": "021-65642222",
        "company_introduce": "基于想定式开发模块，由AI智能体自动生成的人体异常行为分类算法",
        "ms_introduce": "利用MediaPipe姿态估计与规则引擎，对视频中的人体动作进行异常行为分类识别",
        "company_score": 5,
        "ms_score": 4,
    }
]
...
MOCK_SERVICE_APIS = [
    ...
    },
    {
        ...
        "service_id": "b1b8417a-145c-43e3-b0d1-1aa3d7279c6b",
        "name": "技术评测元应用",
        "url": "https://myApiServer.com/metaApp/tech-assessment",
        "method": "post",
        "des": "用于进行原子微服务的技术评测的元应用样例",
        "parameter_type": 3,
        "response_type": 1,
        "is_fake": 1,
        "subtitle": "基于大模型智能体的元应用实例",
        "services": "c582ad98-4a7b-4498-a4d5-a52f991d1c0e",
        "input_name": "技术评测数据",
        "output_name": "技术评测报告",
    ...
    },
    {
        ...
        "response_type": 1,
        "is_fake": 1,
        "subtitle": "智能化乡村医疗服务，提供精准诊断支持",
        "services": "e54ba826-ad95-45aa-928a-cea6d2d94e2a,88a6773d-7274-4071-87df-d4763855f899,fd918206-0564-408b-a096-efd3b64c4efc,fa3fafbb-fb30-492d-93cf-b608e06b4d9a",
        "input_name": "诊断数据",
        "output_name": "诊断结果报告",
    ...
    },
    {
        ...
        "response_type": 1,
        "is_fake": 1,
        "subtitle": "一站式智慧农业解决方案，从播种到收获",
        "services": "4f35b674-4a5b-4b69-a55c-ef0a0ccf2553,241009ad-8465-44a8-befb-bfb9c000c2cb",
        "input_name": "农业数据输入",
    ...
    },
    {
        ...
        "response": '{"code": 200, "message": "\\u5b89\\u5168\\u72b6\\u6001\\u8bc4\\u4f30\\u5b8c\\u6210\\uff01", "data": {"overallStatus": "\\u6b63\\u5e38", "safetyScore": 95, "anomalies": [{"component": "\\u5de6\\u4fa7\\u87ba\\u65cb\\u6868", "severity": "\\u4f4e", "action": "\\u7ee7\\u7eed\\u76d1\\u63a7"}], "systemChecks": {"propulsion": "Pass", "navigation": "Pass", "communication": "Pass", "powertrain": "Pass"}, "redundancyStatus": {"primary": "\\u6b63\\u5e38", "secondary": "\\u51c6\\u5907\\u5c31\\u7eea"}, "recommendedActions": []}}',
          ...
          "response_type": 1,
          "is_fake": 1,
          "subtitle": "智能飞行控制系统，安全高效的空中交通管理",
          "services": "94c085b9-fc0e-4c5b-830f-e97d7d54ede6,b10e3b56-9f2d-43ff-a14f-fb89810d3557,46b8c837-2450-4b87-9b41-d91242f51803",
          "input_name": "飞行任务参数",
          "output_name": "飞行控制结果",
          "output_visualization": 1,
    ...
    # MCP服务
    {
        ...
        "method": "sse",
        "url": "https://fdueblab.cn/mcp-proxy/8778/sse",
        "des": "供智能体调用的基于多智能体协作的金融欺诈检测推理服务，基于多个金融欺诈检测模型的协作，可以对交易进行多维度的风险评估和欺诈预警",
        "parameter_type": 1,
        "response_type": 1,
        "is_fake": 0,
        "response": None,
        "example_msg": "[{\"title\":\"交易欺诈风险评估\",\"content\":\"请分析以下交易：用户A在5分钟内连续进行了10笔大额转账，金额分别为9999元，目标账户都是新注册账户，请评估是否存在欺诈风险\"}]"
    },
    {
        "id": "402cb58e-5214-4a5d-b945-16f7c8651308",
        "service_id": "fa3fafbb-fb30-492d-93cf-b608e06b4d9a",
        "name": "利奈唑胺给药方案优化MCP Server",
        "url": "https://fdueblab.cn/mcp-proxy/25013/sse",
        "method": "sse",
        ...
        "is_fake": 0,
        "response": None,
        "example_msg": "[{\"title\":\"个性化给药方案制定\",\"content\":\"患者信息：65岁男性，体重70kg，肝功能轻度异常，肾功能正常，感染部位为肺部。请制定个性化的利奈唑胺给药方案\"}]"
    },
    {
        "id": "702cb58e-1111-2222-3333-16f7c8651310",
        "service_id": "ad43a293-fb67-4efb-b65b-ec22d9cca5ae",
        "name": "围标检测MCP Server",
        "url": "https://fdueblab.cn/mcp-proxy/26023/sse",
        "method": "sse",
        ...
        "is_fake": 0,
        "response": None,
        "example_msg": "[{\"title\":\"投标价格异常分析\",\"content\":\"请分析以下投标数据：投标单位A报价100万，投标单位B报价101万，投标单位C报价99.8万，是否存在价格异常相似的围标嫌疑\"}]"
    },
    {
        "id": "702cb58e-1111-2222-3333-16f7c8651308",
        "service_id": "ad43a293-fb67-4efb-b65b-ec22d9cca5bg",
        "name": "AML风险检测MCP Server",
        "url": "https://fdueblab.cn/mcp-proxy/26020/sse",
        "method": "sse",
        "des": "提供AML风险检测功能的MCP服务",
        "parameter_type": 1,
        "response_type": 1,
        "is_fake": 0,
        "response": None,
        "example_msg": "[{\"title\":\"风险监测\",\"content\":\"请检测这单笔交易的风险：用户id：cust001, 交易金额10000, 使用现金，属于跨境交易, 国家风险等级：1\"}]"
    },
    {
        "id": "702cb58e-1111-2222-3333-16f7c8651309",
        "service_id": "ad43a293-fb67-4efb-b65b-ec22d9cca5af",
        "name": "家庭机器人3D语义分割MCP Server",
        "url": "https://fdueblab.cn/mcp-proxy/26025/sse",
        "method": "sse",
        "des": "提供家庭机器人3D语义分割功能的MCP服务",
        "parameter_type": 1,
        "response_type": 1,
        "is_fake": 0,
        "response": None,
    ...
    },
    {
        ...
        "service_id": "02a951d1-09b1-4d65-9f6c-cf048e5f620f",
        ...
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"跨境交易反洗钱分析报告\",\"content\":\"请基于以下跨境交易数据生成反洗钱风险分析报告：商户ID M001234，本月跨境交易笔数156笔，交易总额86.5万美元，涉及15个国家和地区，主要交易对手为欧洲和东南亚商户\"}]",
        "response": "{\"steps\":[{\"step\":\"连接样例报告生成MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到样例报告生成MCP服务器\"},{\"step\":\"跨境交易数据解析\",\"status\":\"completed\",\"message\":\"正在解析商户跨境交易数据和洗钱风险指标\"},{\"step\":\"反洗钱算法分析\",\"status\":\"completed\",\"message\":\"正在运行反洗钱检测算法进行数据分析和风险识别\"},{\"step\":\"风险报告生成\",\"status\":\"completed\",\"message\":\"正在生成包含交易模式、风险评估和合规建议的报告\"},{\"step\":\"合规检查输出\",\"status\":\"completed\",\"message\":\"正在进行合规性检查和最终报告格式化\"}],\"final_result\":{\"response\":\"跨境交易反洗钱分析报告生成完成。商户M001234本月交易行为整体正常，156笔交易中发现2笔存在轻微异常（单笔金额超过常规模式）。涉及国家风险评级：欧洲地区低风险，东南亚部分交易需关注。建议：继续监控大额交易，加强对新兴市场交易对手的尽职调查，完善交易记录文档。整体合规等级：B级。\"}}"
    },
    {
        "id": "7a9b8c6d-5e4f-3029-8b7a-6c5d4e3f2019",
        "service_id": "3c3d4e4d-36e4-4436-bea1-63af2117d0cd",
        "name": "课题一风险识别模型推理MCP Server",
    ...
    },
    {
        ...
        "service_id": "b452ae47-92db-4281-8faf-9491ab6baea4",
        "name": "课题三金融风险报告生成MCP Server",
        ...
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"跨境支付反洗钱季度风险报告\",\"content\":\"请生成本季度跨境支付反洗钱风险报告，包含交易风险、地理风险和商户风险三个维度分析，覆盖12万笔跨境交易数据\"}]",
        "response": "{\"steps\":[{\"step\":\"连接课题三金融风险报告生成MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到课题三金融风险报告生成MCP服务器\"},{\"step\":\"跨境交易数据收集\",\"status\":\"completed\",\"message\":\"正在收集本季度12万笔跨境交易数据和反洗钱指标\"},{\"step\":\"反洗钱算法分析\",\"status\":\"completed\",\"message\":\"正在运行课题三反洗钱算法进行多维度风险分析\"},{\"step\":\"合规风险报告编制\",\"status\":\"completed\",\"message\":\"正在编制交易风险、地理风险和商户风险分析报告\"},{\"step\":\"监管合规审核\",\"status\":\"completed\",\"message\":\"正在进行监管合规性检查和最终报告输出\"}],\"final_result\":{\"response\":\"本季度跨境支付反洗钱风险报告生成完成。交易风险方面，识别出285笔可疑交易（占比0.24%），主要集中在大额异常交易。地理风险方面，来自高风险司法管辖区交易占比3.2%，需重点监控。商户风险方面，发现23家商户存在交易模式异常，已列入重点关注名单。整体合规水平良好，建议加强对新兴市场商户的持续监控和定期风险评估。\"}}"
    },
    {
        "id": "5d4c3b2a-1908-7f6e-5d4c-3b2a19087f6e",
        "service_id": "c582ad98-4a7b-4498-a4d5-a52f991d1c0e",
        "name": "课题四模型评测-安全性指纹MCP Server",
        ...
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"反洗钱模型安全性评测\",\"content\":\"请对跨境支付反洗钱检测模型进行安全性指纹检测，评估其在对抗性攻击下的鲁棒性和防欺诈能力\"}]",
        "response": "{\"steps\":[{\"step\":\"连接课题四模型评测-安全性指纹MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到课题四模型评测-安全性指纹MCP服务器\"},{\"step\":\"反洗钱模型架构分析\",\"status\":\"completed\",\"message\":\"正在分析反洗钱检测模型的架构和交易特征参数\"},{\"step\":\"对抗攻击指纹提取\",\"status\":\"completed\",\"message\":\"正在运行课题四算法提取模型在洗钱检测场景下的安全性指纹\"},{\"step\":\"欺诈绕过攻击测试\",\"status\":\"completed\",\"message\":\"正在模拟洗钱者尝试绕过检测的对抗性攻击场景\"},{\"step\":\"模型安全评估\",\"status\":\"completed\",\"message\":\"正在生成反洗钱模型安全性评估和加固建议\"}],\"final_result\":{\"response\":\"反洗钱模型安全性指纹检测完成。模型在面对精心构造的对抗性交易样本时，检测准确率下降至78%（正常情况下为92%）。主要脆弱性：①对交易金额微调敏感②时间特征易被绕过③地理位置伪造检测不足。安全等级评定为C级。建议：增强对抗训练、引入多模态特征验证、实施集成学习提高鲁棒性。\"}}"
    },
    {
        "id": "4b3a2918-7e6f-5d4c-3b2a-190847e6d5c4",
        "service_id": "3d93a110-4618-4b12-83fd-4b5a6f89a106",
        "name": "无人机虚拟仿真MCP Server",
        "url": "https://myMcpServer.com/aircraft-simulation/sse",
        "method": "sse",
        "des": "供智能体调用的无人机虚拟仿真mcp服务，可用于无人机飞行模拟和仿真测试",
        "parameter_type": 1,
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"无人机飞行仿真\",\"content\":\"请启动无人机虚拟仿真环境，模拟在城市环境中的自主飞行任务\"}]",
        "response": "{\"steps\":[{\"step\":\"连接无人机虚拟仿真MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到无人机虚拟仿真MCP服务器\"},{\"step\":\"初始化仿真环境\",\"status\":\"completed\",\"message\":\"正在加载城市环境和飞行场景\"},{\"step\":\"配置无人机参数\",\"status\":\"completed\",\"message\":\"正在设置无人机型号、载重和飞行性能参数\"},{\"step\":\"执行飞行仿真\",\"status\":\"completed\",\"message\":\"正在进行自主飞行路径规划和飞行控制仿真\"},{\"step\":\"生成仿真报告\",\"status\":\"completed\",\"message\":\"正在生成飞行数据和性能分析报告\"}],\"final_result\":{\"response\":\"无人机虚拟仿真完成。在城市环境中成功模拟了15分钟的自主飞行，平均飞行高度120米，飞行速度稳定在25m/s。避障系统响应良好，成功避开了3个建筑物和2个其他飞行器。电池消耗符合预期，剩余电量68%。仿真结果表明飞行方案可行。\"}}"
    },
    {
        "id": "5e4f3029-8b7a-6c5d-4e3f-2019a9b8c6d5",
        "service_id": "78064ca6-3a5d-49cd-8a27-c6a7b52fc20f",
        "name": "无人机低空测绘MCP Server",
        "url": "https://myMcpServer.com/aircraft-mapping/sse",
        "method": "sse",
        "des": "供智能体调用的无人机低空测绘mcp服务，可用于地理测绘和空间数据采集",
        "parameter_type": 1,
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"低空测绘任务\",\"content\":\"请执行指定区域的低空测绘任务，目标区域为2平方公里的农田\"}]",
        "response": "{\"steps\":[{\"step\":\"连接无人机低空测绘MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到无人机低空测绘MCP服务器\"},{\"step\":\"规划测绘航线\",\"status\":\"completed\",\"message\":\"正在生成覆盖目标区域的最优航线规划\"},{\"step\":\"设备系统检查\",\"status\":\"completed\",\"message\":\"正在检查相机、GPS和惯导系统状态\"},{\"step\":\"执行测绘飞行\",\"status\":\"completed\",\"message\":\"正在按照规划航线进行低空测绘数据采集\"},{\"step\":\"数据处理分析\",\"status\":\"completed\",\"message\":\"正在进行图像拼接和地理坐标标定\"}],\"final_result\":{\"response\":\"低空测绘任务完成。成功采集2平方公里农田的高分辨率图像数据，共拍摄368张照片，地面分辨率达到5cm。GPS定位精度±0.3米，图像重叠度85%。生成了完整的正射影像图和数字高程模型，数据质量良好，可用于精准农业分析。\"}}"
    },
    {
        "id": "23a9-4109-967d-a5a7-6f29ba6b8c6d",
        "service_id": "75e5ff68-23a9-4109-967d-a5a76f29ba6b",
        "name": "无人机目标识别MCP Server",
        ...
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"目标识别任务\",\"content\":\"请启动无人机目标识别系统，在指定区域搜索和识别可疑车辆\"}]",
        "response": "{\"steps\":[{\"step\":\"连接无人机目标识别MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到无人机目标识别MCP服务器\"},{\"step\":\"激活识别系统\",\"status\":\"completed\",\"message\":\"正在启动图像处理和目标识别算法\"},{\"step\":\"区域搜索扫描\",\"status\":\"completed\",\"message\":\"正在对指定区域进行系统性搜索扫描\"},{\"step\":\"目标检测分析\",\"status\":\"completed\",\"message\":\"正在运行深度学习模型进行目标检测\"},{\"step\":\"结果确认输出\",\"status\":\"completed\",\"message\":\"正在进行目标分类和位置标定\"}],\"final_result\":{\"response\":\"目标识别任务完成。在搜索区域内成功识别到3辆车辆：1辆白色SUV（置信度95%，坐标31.2°N,121.5°E），1辆蓝色轿车（置信度87%，坐标31.21°N,121.51°E），1辆黑色面包车（置信度92%，坐标31.19°N,121.52°E）。其中黑色面包车行为模式异常，建议重点关注。\"}}"
    },
    {
        "id": "fb67-4efb-b65b-ec22-d9cca5af2918",
        "service_id": "db43a293-fb67-4efb-b65b-ec22d9cca5af",
        "name": "无人机远程控制MCP Server",
        ...
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"远程控制指令\",\"content\":\"请控制无人机飞往指定坐标点并保持悬停状态\"}]",
        "response": "{\"steps\":[{\"step\":\"连接无人机远程控制MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到无人机远程控制MCP服务器\"},{\"step\":\"建立通信链路\",\"status\":\"completed\",\"message\":\"正在与目标无人机建立安全通信连接\"},{\"step\":\"验证控制权限\",\"status\":\"completed\",\"message\":\"正在验证操作权限和安全认证\"},{\"step\":\"执行飞行指令\",\"status\":\"completed\",\"message\":\"正在向无人机发送飞行控制指令\"},{\"step\":\"监控飞行状态\",\"status\":\"completed\",\"message\":\"正在实时监控无人机位置和飞行参数\"}],\"final_result\":{\"response\":\"远程控制指令执行完成。无人机已成功飞抵目标坐标点（31.2°N,121.5°E，高度100米）并保持悬停状态。当前电池电量78%，GPS信号强度良好，风速2.3m/s，飞行状态稳定。已建立持续监控，可随时接收新的控制指令。\"}}"
    },
    {
        "id": "a017-49d9-a784-c7fe-210d234d5e4f",
        "service_id": "abcc5100-a017-49d9-a784-c7fe210d234d",
        "name": "无人机视频分析MCP Server",
        "url": "https://myMcpServer.com/aircraft-video/sse",
        "method": "sse",
        "des": "供智能体调用的无人机视频分析mcp服务，可用于实时视频流分析和智能监控",
        "parameter_type": 1,
        "response_type": 1,
        "is_fake": 1,
        "example_msg": "[{\"title\":\"视频分析任务\",\"content\":\"请对无人机实时传输的视频流进行分析，检测异常活动和人员聚集情况\"}]",
        "response": "{\"steps\":[{\"step\":\"连接无人机视频分析MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到无人机视频分析MCP服务器\"},{\"step\":\"接收视频流\",\"status\":\"completed\",\"message\":\"正在接收无人机实时传输的高清视频流\"},{\"step\":\"视频预处理\",\"status\":\"completed\",\"message\":\"正在进行视频降噪和图像增强处理\"},{\"step\":\"智能分析检测\",\"status\":\"completed\",\"message\":\"正在运行AI算法进行目标检测和行为分析\"},{\"step\":\"异常识别报告\",\"status\":\"completed\",\"message\":\"正在生成分析结果和异常事件报告\"}],\"final_result\":{\"response\":\"视频分析任务完成。在30分钟的视频分析中，检测到以下情况：发现3处人员聚集点，分别有15人、8人和22人；识别出1起异常行为事件（快速奔跑，时间点14:23）；监测到2辆车辆违规停放；整体区域活动水平为中等，无重大安全隐患。建议继续监控异常行为区域。\"}}"
    },
    {
        "id": "9e8f7d6c-5b4a-3918-7e6f-5d4c3b2a1909",
        "service_id": "1e5dc8b7-34a7-4b2d-9fd8-c2a8d5e0b3f4",
        "name": "金融欺诈检测推理元应用",
        ...
        "services": "c48aad98-4a7b-4498-a4d5-ac2f991d1c0d,02a951d1-09b1-4d65-9f6c-cf048e5f620f,c582ad98-4a7b-4498-a4d5-a52f991d1c0e",
        "input_name": "交易数据",
        "output_name": "欺诈风险评估报告",
        "output_visualization": 1,
        "submit_button_text": "开始检测",
        "response": None
    },
    {
        "id": "8d7c6b5a-4928-3817-6f5e-4d3c2b1a0908",
        "service_id": "8f3dc9c8-45b8-4c3e-8fe9-d3b9e6f1c4g5",
        "name": "智能飞行控制元应用",
        "url": "https://myApiServer.com/aircraft/flight-control/metaApp",
        "method": "post",
        "des": "基于大模型智能体的元应用，专门用于无人机智能飞行控制和任务管理",
        "parameter_type": 3,
        "response_type": 1,
        "is_fake": 1,
        "subtitle": "无人机智能控制系统，精确安全的空中作业助手",
        "services": "75e5ff68-23a9-4109-967d-a5a76f29ba6b,db43a293-fb67-4efb-b65b-ec22d9cca5af",
        "input_name": "飞行任务指令",
        "output_name": "飞行执行报告",
        "output_visualization": 1,
        ...
        {
        "id": "6aa1c2d4-2701-4a90-9b01-000000000001",
        "service_id": "healthbb-fb30-492d-93cf-b608e06b4d7a",
        "name": "healthCheck",
        "url": "https://fdueblab.cn/mcp-proxy/27001/health",
        "method": "get",
        "des": "判断微服务状态是否正常可用",
        "parameter_type": 0,
        "response_type": 0,
    ...
    {
        "id": "6aa1c2d4-2701-4a90-9b01-000000000002",
        "service_id": "healthbb-fb30-492d-93cf-b608e06b4d7a",
        "name": "analyze",
        "url": "https://fdueblab.cn/mcp-proxy/27001/analyze",
        "method": "post",
        "des": "对输入文本进行情感分析",
        "parameter_type": 2,
        "response_type": 1,
    ...
    {
        "id": "6aa1c2d4-2701-4a90-9b01-000000000003",
        "service_id": "healthbb-fb30-492d-93cf-b608e06b4d7a",
        "name": "modelInfo",
        "url": "https://fdueblab.cn/mcp-proxy/27001/model-info",
        "method": "get",
        "des": "获取模型信息",
        "parameter_type": 0,
        "response_type": 1,
    ...
    },
    {
        ...
        "service_id": "healthbb-fb30-492d-93cf-b608e06b4d7z",
        "name": "情感分析MCP Server",
        "url": "https://fdueblab.cn/mcp-proxy/27001/sse",
        "method": "sse",
        "des": "提供情感分析功能的MCP服务",
        "parameter_type": 1,
        "response_type": 1,
        "is_fake": 1,
        "response": "{\"steps\":[{\"step\":\"连接情感分析MCP服务器\",\"status\":\"completed\",\"message\":\"成功连接到情感分析MCP服务器\"},{\"step\":\"接收文本\",\"status\":\"completed\",\"message\":\"已接收待分析文本\"},{\"step\":\"文本预处理\",\"status\":\"completed\",\"message\":\"正在进行分词与清洗\"},{\"step\":\"情感分类\",\"status\":\"completed\",\"message\":\"模型推理完成\"},{\"step\":\"结果生成\",\"status\":\"completed\",\"message\":\"已生成情感倾向与置信度\"}],\"final_result\":{\"response\":\"情感分析完成。文本'Oh no, what a mess!'的情感倾向为负面（negative），置信度为97%。该文本表达了沮丧和失望的情绪，语气带有明显的消极色彩。\"}}",
        "example_msg": "[{\"title\":\"情感分析任务\",\"content\":\"请分析给定文本的情感倾向：“Oh no, what a mess!”\"}]"
    },
    {
        "id": "ga001api-3c4d-5e6f-7890-123456789001",
        "service_id": "ga001a2b-3c4d-5e6f-7890-123456789001",
        "name": "scenario_generated_code",
        "url": "/services/ga001a2b-3c4d-5e6f-7890-123456789001/scenario-generated-code",
        "method": "get",
        "des": "下载想定式生成的算法源码: transaction_risk_predictor.py",
        "parameter_type": 0,
        "response_type": 0,
        "is_fake": 0,
        "response": None,
    ...
    {
        "id": "ga002api-3c4d-5e6f-7890-123456789002",
        "service_id": "ga002a2b-3c4d-5e6f-7890-123456789002",
        "name": "scenario_generated_code",
        "url": "/services/ga002a2b-3c4d-5e6f-7890-123456789002/scenario-generated-code",
        "method": "get",
        "des": "下载想定式生成的算法源码: uav_route_planner.py",
        "parameter_type": 0,
        "response_type": 0,
        "is_fake": 0,
        "response": None,
    ...
    {
        "id": "ga003api-3c4d-5e6f-7890-123456789003",
        "service_id": "ga003a2b-3c4d-5e6f-7890-123456789003",
        "name": "scenario_generated_code",
        "url": "/services/ga003a2b-3c4d-5e6f-7890-123456789003/scenario-generated-code",
        "method": "get",
        "des": "下载想定式生成的算法源码: crop_pest_identifier.py",
        "parameter_type": 0,
        "response_type": 0,
        "is_fake": 0,
        "response": None,
    ...
    {
        "id": "ga004api-3c4d-5e6f-7890-123456789004",
        "service_id": "ga004a2b-3c4d-5e6f-7890-123456789004",
        "name": "scenario_generated_code",
        "url": "/services/ga004a2b-3c4d-5e6f-7890-123456789004/scenario-generated-code",
        "method": "get",
        "des": "下载想定式生成的算法源码: rule_based_action_classifier.py",
        "parameter_type": 0,
        "response_type": 0,
        "is_fake": 0,
        "response": None,
...
MOCK_SERVICE_API_PARAMETERS = [
    ...
    {
        "id": "d9f1c3a2-2701-4a90-9b01-000000000004",
        "api_id": "6aa1c2d4-2701-4a90-9b01-000000000002",
        "name": "text",
        "type": "string",
        "des": "待分析文本",
    },
...
MOCK_SERVICE_API_TOOLS = [
    ...
    # 情感分析MCP Server 的工具
    {
        "id": "tool-029-health-check-mcp2",
        "api_id": "94395fbc-7349-4a06-80db-04c417f4bd04",
        "name": "healthCheck",
        "description": "判断微服务状态是否正常可用",
    },
    {
        "id": "tool-030-model-info-mcp2",
        "api_id": "94395fbc-7349-4a06-80db-04c417f4bd04",
        "name": "modelInfo",
        "description": "获取情感分析模型的详细信息，包括模型版本、支持的语言、分类类别等",
    },
    {
        "id": "tool-031-analyze-mcp2",
        "api_id": "94395fbc-7349-4a06-80db-04c417f4bd04",
        "name": "analyze",
        "description": "对输入的文本进行情感分析，返回情感倾向（positive/negative/neutral）和置信度",
    },
    # 围标检测MCP Server 的工具
    {
    ...
    # 样例报告生成MCP Server 的工具
    {
        "id": "tool-011-report-generation-health",
        "api_id": "8f7e6d5c-4b3a-2918-7e6f-5d4c3b2a1908",
        "name": "healthCheck",
        "description": "判断样例报告生成MCP服务状态是否正常可用",
    },
    {
        "id": "tool-012-generate-report",
        "api_id": "8f7e6d5c-4b3a-2918-7e6f-5d4c3b2a1908",
        "name": "generateReport",
        "description": "基于输入数据生成分析报告",
    },
    # 课题一风险识别模型推理MCP Server 的工具
    {
        "id": "tool-013-risk-identification-health",
        "api_id": "7a9b8c6d-5e4f-3029-8b7a-6c5d4e3f2019",
        "name": "healthCheck",
        "description": "判断课题一风险识别模型推理MCP服务状态是否正常可用",
    },
    {
        "id": "tool-014-risk-predict",
        "api_id": "7a9b8c6d-5e4f-3029-8b7a-6c5d4e3f2019",
        "name": "predict",
        "description": "对客户信息进行风险识别和模型推理分析",
    },
    {
        "id": "tool-015-risk-evaluate",
        "api_id": "7a9b8c6d-5e4f-3029-8b7a-6c5d4e3f2019",
        "name": "evaluate",
    ...
    {
        "id": "tool-016-financial-risk-health",
        "api_id": "6e5d4c3b-2a19-0827-6e5d-4c3b2a190827",
        "name": "healthCheck",
        "description": "判断课题三金融风险报告生成MCP服务状态是否正常可用",
    },
    {
        "id": "tool-017-generate-financial-report",
        "api_id": "6e5d4c3b-2a19-0827-6e5d-4c3b2a190827",
        "name": "generateFinancialReport",
        "description": "生成金融风险报告，包含信用风险、市场风险和操作风险分析",
    },
    {
        "id": "tool-018-analyze-risk-data",
        "api_id": "6e5d4c3b-2a19-0827-6e5d-4c3b2a190827",
        "name": "analyzeRiskData",
        "description": "分析多维度风险数据和指标",
    },
    # 课题四模型评测-安全性指纹MCP Server 的工具
    {
        "id": "tool-019-security-fingerprint-health",
        "api_id": "5d4c3b2a-1908-7f6e-5d4c-3b2a19087f6e",
        "name": "healthCheck",
        "description": "判断课题四模型评测-安全性指纹MCP服务状态是否正常可用",
    },
    {
        "id": "tool-020-security-fingerprint-detect",
        "api_id": "5d4c3b2a-1908-7f6e-5d4c-3b2a19087f6e",
        "name": "securityFingerprintDetect",
        "description": "对机器学习模型进行安全性指纹检测",
    },
    {
        "id": "tool-021-evaluate-model-security",
        "api_id": "5d4c3b2a-1908-7f6e-5d4c-3b2a19087f6e",
        "name": "evaluateModelSecurity",
        "description": "评估模型抗攻击能力和安全风险等级",
    },
    # 无人机虚拟仿真MCP Server 的工具
    {
        "id": "tool-022-aircraft-simulation-health",
        "api_id": "4b3a2918-7e6f-5d4c-3b2a-190847e6d5c4",
        "name": "healthCheck",
        "description": "判断无人机虚拟仿真MCP服务状态是否正常可用",
    },
    {
        "id": "tool-023-start-simulation",
        "api_id": "4b3a2918-7e6f-5d4c-3b2a-190847e6d5c4",
        "name": "startSimulation",
        "description": "启动无人机虚拟仿真环境",
    },
    {
        "id": "tool-024-flight-simulation",
        "api_id": "4b3a2918-7e6f-5d4c-3b2a-190847e6d5c4",
        "name": "flightSimulation",
        "description": "执行无人机飞行仿真和路径规划",
    },
    # 无人机低空测绘MCP Server 的工具
    {
        "id": "tool-025-aircraft-mapping-health",
        "api_id": "5e4f3029-8b7a-6c5d-4e3f-2019a9b8c6d5",
        "name": "healthCheck",
        "description": "判断无人机低空测绘MCP服务状态是否正常可用",
    },
    {
        "id": "tool-026-plan-mapping-route",
        "api_id": "5e4f3029-8b7a-6c5d-4e3f-2019a9b8c6d5",
        "name": "planMappingRoute",
        "description": "规划测绘航线和覆盖区域",
    },
    {
        "id": "tool-027-execute-mapping",
        "api_id": "5e4f3029-8b7a-6c5d-4e3f-2019a9b8c6d5",
        "name": "executeMapping",
        "description": "执行低空测绘数据采集任务",
    },
    # 无人机目标识别MCP Server 的工具
    {
        "id": "tool-028-aircraft-detection-health",
        "api_id": "23a9-4109-967d-a5a7-6f29ba6b8c6d",
        "name": "healthCheck",
        "description": "判断无人机目标识别MCP服务状态是否正常可用",
    },
    {
        "id": "tool-029-detect-targets",
        "api_id": "23a9-4109-967d-a5a7-6f29ba6b8c6d",
        "name": "detectTargets",
        "description": "检测和识别空中或地面目标",
    },
    {
        "id": "tool-030-analyze-objects",
        "api_id": "23a9-4109-967d-a5a7-6f29ba6b8c6d",
        "name": "analyzeObjects",
        "description": "分析识别到的目标对象特征",
    },
    # 无人机远程控制MCP Server 的工具
    {
        "id": "tool-031-aircraft-control-health",
        "api_id": "fb67-4efb-b65b-ec22-d9cca5af2918",
        "name": "healthCheck",
        "description": "判断无人机远程控制MCP服务状态是否正常可用",
    },
    {
        "id": "tool-032-remote-control",
        "api_id": "fb67-4efb-b65b-ec22-d9cca5af2918",
        "name": "remoteControl",
        "description": "远程控制无人机飞行和操作",
    },
    {
        "id": "tool-033-flight-monitoring",
        "api_id": "fb67-4efb-b65b-ec22-d9cca5af2918",
        "name": "flightMonitoring",
        "description": "实时监控无人机飞行状态和参数",
    },
    # 无人机视频分析MCP Server 的工具
    {
        "id": "tool-034-aircraft-video-health",
        "api_id": "a017-49d9-a784-c7fe-210d234d5e4f",
        "name": "healthCheck",
        "description": "判断无人机视频分析MCP服务状态是否正常可用",
    },
    {
        "id": "tool-035-analyze-video-stream",
        "api_id": "a017-49d9-a784-c7fe-210d234d5e4f",
        "name": "analyzeVideoStream",
        "description": "分析无人机实时视频流数据",
    },
    {
        "id": "tool-036-detect-anomalies",
        "api_id": "a017-49d9-a784-c7fe-210d234d5e4f",
        "name": "detectAnomalies",
        "description": "检测视频中的异常活动和事件",
    },
]
